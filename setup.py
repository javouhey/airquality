...
#
# However, when we do this, we also import `airquality/__init__.py'. If this
...
def is_git_project():
    return False
    # a hack since I don't have git command line in windows GB!
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'airquality_cli = airquality.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'airquality_gui = airquality.gui:entry_point'
        # ]
    }
)
